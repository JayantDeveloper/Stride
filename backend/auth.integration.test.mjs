...
test('auth signup creates a session and scopes task reads to the signed-in user', async (t) => {
  ...
  process.env.DATABASE_URL = `pg-mem://focus-exec-auth-${Date.now()}-${Math.random()}`
  delete process.env.POSTGRES_URL
  process.env.BETTER_AUTH_SECRET = '0123456789abcdef0123456789abcdef0123456789abcdef'
  ...
  process.env.GOOGLE_REDIRECT_URI = 'http://localhost:5001/api/auth/callback/google'
